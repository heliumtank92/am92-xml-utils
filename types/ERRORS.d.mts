export namespace INVALID_INTERPOLATE_XML_ARGS_ERROR {
    const message: string;
    const statusCode: number;
    const errorCode: string;
}
export namespace INVALID_XML_TO_JSON_XML_ARGS_ERROR {
...
export namespace INVALID_XML_TO_JSON_XPATH_ARGS_ERROR {
